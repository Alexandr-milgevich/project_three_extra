package gigabank.accountmanagement.design.proxy;
...
public class SecurityLoggingProxy {
    ...
    /**
     * Конструктор с внедрением зависимости реального сервиса.
     *
     * @param bankAccountService экземпляр {@link BankAccountService} для выполнения операций
     */
