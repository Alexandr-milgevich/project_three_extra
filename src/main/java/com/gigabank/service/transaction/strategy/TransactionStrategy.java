 ...
 * свою реализацию метода {@link #process(AccountRequestDto, BigDecimal, Map)}
...
public interface TransactionStrategy {
     ...
     *
     * @param accountDto банковский счет ({@link AccountRequestDto}), с которого происходит транзакция
